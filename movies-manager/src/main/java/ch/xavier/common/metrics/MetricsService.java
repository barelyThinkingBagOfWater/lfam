...
public class MetricsService {
    ...
    public void notifyTagsImported(double number) {
        tagCountersFactory.getTagsImportedCounter().increment(number);
    }
    ...
    public void notifyMoviesImported(double number) {
        movieCountersFactory.getMoviesImportedCounter().increment(number);
    }
    ...
    public void notifyRatingsImported(double number) {
        ratingCountersFactory.getRatingsImportedCounter().increment(number);
    }
